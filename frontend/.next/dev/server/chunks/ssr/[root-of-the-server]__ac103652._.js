...
"[project]/components/charts/PriceHistoryChart.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PriceHistoryChart({ priceHistory, metadata, awayTeam, homeTeam, targetAwayTeam, targetHomeTeam, awayCorrespondsTo, homeCorrespondsTo, isLiveData = false }) {
    ...
    const chartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        if (metadata?.game_start_ts) {
            ...
            const gameIntervalData = priceHistory.filter((point)=>point.timestamp * 1000 >= gameStartMs);
            ...
            if (gameIntervalData.length > 0) {
                ...
                filteredHistory = priceHistory.filter((point)=>point.timestamp * 1000 >= marketOpenMs);
            }
        }
    ...
    const CustomTooltip = ({ active, payload })=>{
        if (active && payload && payload.length) {
            ...
            let timeLabel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(data.timestamp), 'MMM d, h:mm a');
            if (metadata?.game_start_ts) {
                const gameStartMs = metadata.game_start_ts * 1000;
...
"[project]/app/game/[sport]/[gameId]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$charts$2f$PriceHistoryChart$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/charts/PriceHistoryChart.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function GameDetailPage({ params }) {
    const { sport, gameId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["use"])(params);
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "space-y-6",
                            children: similar_games.map((similar, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ac103652._.js.map